...
/**
 * Pagination Class Bootstrap Integration Edited
 *
 * @package     CodeIgniter-Bootstrap
 * @subpackage  Libraries
 * @category    Pagination-Bootstrap
 * @copyright   Copyright (c) 2014, Mainmath
 * @author      santensuru
 * @link        
 */
